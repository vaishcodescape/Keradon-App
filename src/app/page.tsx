      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative">
          <div className="absolute inset-0 transition-all duration-2000">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400/20 via-pink-400/20 via-purple-400/20 to-pink-400/20 blur-3xl rounded-full -z-10 animate-gradient-shift opacity-0 transition-all duration-2000 ease-in-out" />
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 via-purple-400/20 via-blue-400/20 to-purple-400/20 blur-3xl rounded-full -z-10 animate-gradient-shift-delay-1 opacity-0 transition-all duration-2000 ease-in-out" />
            <div className="absolute inset-0 bg-gradient-to-r from-pink-400/20 via-orange-400/20 via-pink-400/20 to-orange-400/20 blur-3xl rounded-full -z-10 animate-gradient-shift-delay-2 opacity-0 transition-all duration-2000 ease-in-out" />
            <div className="absolute inset-0 bg-gradient-to-r from-green-400/20 via-blue-400/20 via-green-400/20 to-blue-400/20 blur-3xl rounded-full -z-10 animate-gradient-shift-delay-3 opacity-0 transition-all duration-2000 ease-in-out" />
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 via-yellow-400/20 via-orange-400/20 to-yellow-400/20 blur-3xl rounded-full -z-10 animate-gradient-shift-delay-4 opacity-0 transition-all duration-2000 ease-in-out" />
          </div>
          <Card className={`bg-black/90 backdrop-blur-xl border-gray-800/30 transition-all duration-2000 ease-in-out shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:border-purple-500/30 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'} max-w-5xl mx-auto p-12`}>
